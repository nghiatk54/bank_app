...
const Testimonials = () => {
    return (
        ...
        >
            <div className="absolute -right-[50%] z-[0] w-[60%] h-[60%] rounded-full blue__gradient" />
            ...
            <div className="flex sm:justify-start justify-center flex-wrap w-full feedback-container relative z-[1]">
                {feedback.map((card) => (
